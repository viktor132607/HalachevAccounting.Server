    ...
    return lang === "bg" ? (
            ...
            <div className={cardClass}>
                ...
                <div className={groupClass}>
                    <p className={textClass}>
                        Настоящата политика за бисквитките описва как „Репаро Нау“ ЕООД („Репаро“, „ние“) използва бисквитки и подобни технологии в reparonow.com и свързаните дигитални услуги.
                    </p>
                    <p className={textClass}>
        ...
        <div className={wrapperClass}>
            ...
            <div className={cardClass}>
                ...
                <div className={groupClass}>
                    <p className={textClass}>
                        This cookie policy explains how Reparo Now EOOD (“Reparo”, “we”) uses cookies and similar technologies on reparonow.com and related digital services.
                    </p>
                    <p className={textClass}>
